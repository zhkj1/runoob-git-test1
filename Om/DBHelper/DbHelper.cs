...
namespace MallWCF.DBHelper
{
    ...
    public class DbHelper
    {
        ...
        public DbHelper(string connstring)
        {
            ...
            // ConnectionString = AppConfig.DefaultConnect.ToString();
        ...
        public static int ExecuteNonQueryNew(CommandType cmdType, string cmdText, params DbParameter[] parameters)
        {
            int num = 0;
            try
            {
        ...
        //返回主键
        public static int ExecuteNonQueryNew(DbTransaction isOpenTrans, CommandType cmdType, string cmdText, params DbParameter[] parameters)
        {
            int num = 0;
            try
            {
