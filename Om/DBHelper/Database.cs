...
namespace MallWCF.DBHelper
{
    ...
    public class Database : IDatabase, IDisposable
    {
        ...
        /// <param name="isOpenTrans">事务对象</param>
        /// <returns></returns>
        public int ExecuteBySqlNew(StringBuilder strSql, DbTransaction isOpenTrans)
        {
            return DbHelper.ExecuteNonQueryNew(isOpenTrans, CommandType.Text, strSql.ToString());
        }
        /// <summary>
        /// 执行SQL语句
        /// </summary>
        ...
        public int Insert<T>(T entity)
        {
            ...
            val = DbHelper.ExecuteNonQueryNew(CommandType.Text, strSql.ToString(), parameter);
            return val;
        }
        /// <summary>
        /// 插入数据
        ...
        public int Insert<T>(T entity, DbTransaction isOpenTrans)
        {
            ...
            StringBuilder strSql = DatabaseCommon.InsertSql<T>(entity);
            DbParameter[] parameter = DatabaseCommon.GetParameter<T>(entity);
            val = DbHelper.ExecuteNonQueryNew(isOpenTrans, CommandType.Text, strSql.ToString(), parameter);
        ...
        public int Update<T>(T entity)
        {
            ...
            DbParameter[] parameter = DatabaseCommon.GetParameterNew<T>(entity);
            val = DbHelper.ExecuteNonQuery(CommandType.Text, strSql.ToString(), parameter);
            return Convert.ToInt32(val);
        }
        /// <summary>
