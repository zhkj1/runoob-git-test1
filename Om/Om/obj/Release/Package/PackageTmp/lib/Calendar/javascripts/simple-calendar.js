      ...
      if (options.showMark) {
        ...
        if (data) {
          ...
          daysElement.forEach(function (v, i) {
            ...
            //alert(data[year + '-' + currentmonth + '-' + day]);
            if (data[year + '-' + currentmonth + '-' + day]) {
                if (parseInt(data[year + '-' + currentmonth + '-' + day].split(",")[0]) > parseInt(data[year + '-' + currentmonth + '-' + day].split(",")[1])) {
              ...
              v.innerHTML += data[year + '-' + currentmonth + '-' + day];
            } else {
